...
object ModelValidationResult
{
	 ...
	 *  @param original Original model
	  ...
	  */
	def missing(original: typeless.Model[Property], missingDeclarations: Set[PropertyDeclaration]) =
	 ...
	 *  @param original Original model
	  ...
	  */
	def castFailed(original: typeless.Model[Property], failedConversions: Set[(Constant, DataType)]) =
	 ...
	 */
	def missingChildren(original: typeless.Model[Property], missingChildren: Map[String, ModelDeclaration]) =
	 ...
	 *  @param original Original model
	  ...
	  */
	def success(original: typeless.Model[Property], validated: Model) =
 ...
 *  @param missingChildren Missing declared child declarations
  */
case class ModelValidationResult private(original: typeless.Model[Property], success: Option[Model] = None,
