...
object ValueUnwraps
{
	...
	implicit def valueToYear(v: Value): Year = v.getYear
	implicit def valueToYearOption(v: Value): Option[Year] = v.year
	
	implicit def valueToMonth(v: Value): Month = v.getMonth
	implicit def valueToMonthOption(v: Value): Option[Month] = v.month
	
	implicit def valueToYearMonth(v: Value): YearMonth = v.getYearMonth
	implicit def valueToYearMonthOption(v: Value): Option[YearMonth] = v.yearMonth
}
