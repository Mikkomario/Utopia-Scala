...
object TargetingManyRowsLike
{
	...
	implicit class RecursiveTargetingManyRows[T <: TargetingManyRowsLike[A, T], +A](val t: T) extends AnyVal
	{
...
/**
  ...
  */
trait TargetingManyRowsLike[+A, +Repr] extends TargetingManyLike[A, Repr]
{
	def take(n: Int): Repr
	def drop(n: Int): Repr
