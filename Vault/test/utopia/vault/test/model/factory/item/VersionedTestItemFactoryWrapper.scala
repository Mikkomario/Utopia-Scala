...
/**
  * Common trait for classes that implement VersionedTestItemFactory by wrapping a 
  * VersionedTestItemFactory instance
  * @tparam A Type of constructed instances
  * @tparam Repr Implementing type of this factory
  * @author Mikko Hilpinen
  * @since 04.07.2025, v1.22
  */
trait VersionedTestItemFactoryWrapper[A <: VersionedTestItemFactory[A], +Repr] 
	extends VersionedTestItemFactory[Repr]
{
	// ABSTRACT	--------------------
