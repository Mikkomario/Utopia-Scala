...
- **"combos" / "indices": [[String]]** - An array of multiple key indices, each written as an array of property names
  - Alternatively you can provide **"combo"** or **"index"** property that contains a single multiple key index array
