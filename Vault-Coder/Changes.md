...
## v1.5 (in development)
### Breaking Changes
- Autogenerated column names for duration type now contain `_minutes`, `_seconds` etc. suffix
- Autogenerated column names for enumeration types now contain `_id` suffix
