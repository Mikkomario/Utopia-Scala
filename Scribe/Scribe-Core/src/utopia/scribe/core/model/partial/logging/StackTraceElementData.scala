...
object StackTraceElementData extends FromModelFactoryWithSchema[StackTraceElementData]
{
	// ATTRIBUTES	--------------------
	...
	override protected def fromValidatedModel(valid: Model) = 
		StackTraceElementData(valid("className").getString, valid("methodName").getString, 
...
/**
  ...
  */
case class StackTraceElementData(className: String, methodName: String, lineNumber: Int, 
