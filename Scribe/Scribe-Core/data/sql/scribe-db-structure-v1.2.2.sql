...
CREATE TABLE `issue`(
	...
	INDEX sc_i_created_idx (`created`), 
	INDEX sc_i_combo_1_idx (severity_level, context)
...
CREATE TABLE `stack_trace_element_record`(
	...
	`line_number` INT, 
	`cause_id` INT, 
	INDEX sc_ster_combo_1_idx (file_name, class_name, method_name, line_number), 
	CONSTRAINT sc_ster_ster_cause_ref_fk FOREIGN KEY sc_ster_ster_cause_ref_idx (cause_id) REFERENCES `stack_trace_element_record`(`id`) ON DELETE SET NULL
)Engine=InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
...
CREATE TABLE `error_record`(
	...
	`cause_id` INT, 
	INDEX sc_er_combo_1_idx (exception_type, stack_trace_id), 
	CONSTRAINT sc_er_ster_stack_trace_ref_fk FOREIGN KEY sc_er_ster_stack_trace_ref_idx (stack_trace_id) REFERENCES `stack_trace_element_record`(`id`) ON DELETE CASCADE, 
	CONSTRAINT sc_er_er_cause_ref_fk FOREIGN KEY sc_er_er_cause_ref_idx (cause_id) REFERENCES `error_record`(`id`) ON DELETE SET NULL
)Engine=InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
...
CREATE TABLE `issue_variant`(
	...
	`details` VARCHAR(128), 
	`created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, 
	INDEX sc_iv_created_idx (`created`), 
	INDEX sc_iv_combo_1_idx (issue_id, version, error_id), 
	CONSTRAINT sc_iv_i_issue_ref_fk FOREIGN KEY sc_iv_i_issue_ref_idx (issue_id) REFERENCES `issue`(`id`) ON DELETE CASCADE, 
	CONSTRAINT sc_iv_er_error_ref_fk FOREIGN KEY sc_iv_er_error_ref_idx (error_id) REFERENCES `error_record`(`id`) ON DELETE SET NULL
)Engine=InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
...
CREATE TABLE `issue_occurrence`(
	...
	INDEX sc_io_combo_1_idx (last_occurrence, first_occurrence), 
	CONSTRAINT sc_io_iv_case_ref_fk FOREIGN KEY sc_io_iv_case_ref_idx (case_id) REFERENCES `issue_variant`(`id`) ON DELETE CASCADE
)Engine=InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
...
CREATE TABLE `issue_alias`(
	...
	`created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, 
	CONSTRAINT sc_ia_i_issue_ref_fk FOREIGN KEY sc_ia_i_issue_ref_idx (issue_id) REFERENCES `issue`(`id`) ON DELETE CASCADE
)Engine=InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
...
CREATE TABLE `issue_comment`(
	...
	`created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, 
	INDEX sc_ic_created_idx (`created`), 
	CONSTRAINT sc_ic_i_issue_ref_fk FOREIGN KEY sc_ic_i_issue_ref_idx (issue_id) REFERENCES `issue`(`id`) ON DELETE CASCADE
)Engine=InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
...
CREATE TABLE `issue_resolution`(
	...
	INDEX sc_ir_created_idx (`created`), 
	INDEX sc_ir_deprecates_idx (`deprecates`), 
	INDEX sc_ir_notifies_idx (`notifies`), 
	CONSTRAINT sc_ir_i_resolved_issue_ref_fk FOREIGN KEY sc_ir_i_resolved_issue_ref_idx (resolved_issue_id) REFERENCES `issue`(`id`) ON DELETE CASCADE, 
	CONSTRAINT sc_ir_ic_comment_ref_fk FOREIGN KEY sc_ir_ic_comment_ref_idx (comment_id) REFERENCES `issue_comment`(`id`) ON DELETE SET NULL
)Engine=InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
...
CREATE TABLE `issue_notification`(
	...
	`created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, 
	`closed` DATETIME, 
	INDEX sc_in_created_idx (`created`), 
	INDEX sc_in_closed_idx (`closed`), 
	CONSTRAINT sc_in_ir_resolution_ref_fk FOREIGN KEY sc_in_ir_resolution_ref_idx (resolution_id) REFERENCES `issue_resolution`(`id`) ON DELETE CASCADE
)Engine=InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
