...
object MouseButtonStateEvent
{
	...
	trait MouseButtonFilteringFactory[+E <: MouseButtonStateEventLike[_], +Repr]
		extends Any with MouseFilteringFactory[E, Repr]
	{
		/**
	...
	implicit class RichMouseButtonStateEventFilter[E <: MouseButtonStateEventLike[_]](val f: Filter[E])
		extends AnyVal with MouseButtonFilteringFactory[E, Filter[E]]
	{
