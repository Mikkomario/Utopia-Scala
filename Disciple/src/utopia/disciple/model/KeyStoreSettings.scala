...
/**
  ...
  *                    Default = false.
  */
case class KeyStoreSettings(storePath: Path, storePassword: Option[String] = None, keyPassword: Option[String] = None,
                            storeType: Option[String] = None, throwErrors: Boolean = false)
