...
trait SingleIdDescribedAccess[A, +D] extends SingleIntIdModelAccess[A]
{
	...
	/**
	  ...
	  */
	protected def singleDescriptionAccess: DescriptionLinkAccessOld
	/**
	  * @return An access point used for accessing groups of description links for this model type
	  */
	protected def manyDescriptionsAccess: DescriptionLinksAccessOld
	...
	private def pullDescribed(pullDescriptions: => Iterable[DescriptionLinkOld])(implicit connection: Connection) =
