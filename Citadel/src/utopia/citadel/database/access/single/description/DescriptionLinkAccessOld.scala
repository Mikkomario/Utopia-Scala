...
object DescriptionLinkAccessOld
{
	// OTHER    -----------------------------
...
/**
  ...
  */
@deprecated("Replaced with LinkedDescriptionAccess", "v2.0")
trait DescriptionLinkAccessOld extends SingleRowModelAccess[DescriptionLinkOld] with NonDeprecatedView[DescriptionLinkOld]
{
	// ABSTRACT ----------------------------
