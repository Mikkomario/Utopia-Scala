...
/**
  ...
  * @since 2021-10-23
  */
trait UniqueUserLanguageLinkAccess
	extends SingleRowModelAccess[UserLanguageLink]
		with DistinctModelAccess[UserLanguageLink, Option[UserLanguageLink], Value] with Indexed
{
	// COMPUTED	--------------------
