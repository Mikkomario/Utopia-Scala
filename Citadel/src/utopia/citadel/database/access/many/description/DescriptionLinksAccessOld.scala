...
object DescriptionLinksAccessOld
{
	// OTHER    -------------------------------
	...
	/**
	  ...
	  */
	def apply(linkTable: Table, linkAttName: String): DescriptionLinksAccessOld =
		apply(DescriptionLinkFactoryOld(linkTable, linkAttName))
	...
	/**
	  ...
	  */
	def apply(linkFactory: DescriptionLinkFactoryOld[DescriptionLinkOld]): DescriptionLinksAccessOld =
		new SimpleDescriptionLinksAccess(linkFactory)
	
	
	// NESTED   -------------------------------
	
	private class SimpleDescriptionLinksAccess(override val factory: DescriptionLinkFactoryOld[DescriptionLinkOld])
		extends DescriptionLinksAccessOld
}
...
/**
  ...
  */
@deprecated("Replaced with LinkedDescriptionsAccess", "v2.0")
trait DescriptionLinksAccessOld extends DescriptionLinksForManyAccessLike with NonDeprecatedView[DescriptionLinkOld]
{
	// ABSTRACT ----------------------------
	...
	class DescriptionsOfMany(targetIds: Set[Int]) extends DescriptionLinksForManyAccessLike with SubView
	{
		...
		def inPreferredLanguages(implicit connection: Connection,
		                                  languageIds: LanguageIds): Map[Int, Vector[DescriptionLinkOld]] =
		...
		override protected def parent = DescriptionLinksAccessOld.this
	...
	class DescriptionsOfSingle(targetId: Int) extends DescriptionLinksAccessLike with SubView
	{
		...
		/**
		  ...
		  */
		def inPreferredLanguages(implicit connection: Connection, languageIds: LanguageIds): Vector[DescriptionLinkOld] =
		{
			languageIds.headOption match
			{
		...
		/**
		  ...
		  */
		def withRolesInPreferredLanguages(roleIds: Set[Int])(
			implicit connection: Connection, languageIds: LanguageIds): Vector[DescriptionLinkOld] =
		{
