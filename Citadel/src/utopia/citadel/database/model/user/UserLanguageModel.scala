...
object UserLanguageModel extends DataInserter[UserLanguageModel, UserLanguage, UserLanguageData]
{
	...
	/**
	  ...
	  */
	def factory = UserLanguageFactory
	...
	override def complete(id: Value, data: UserLanguageData) = UserLanguage(id.getInt, data)
...
/**
  ...
  * @since 2021-10-23
  */
case class UserLanguageModel(id: Option[Int] = None, userId: Option[Int] = None, 
	languageId: Option[Int] = None, familiarityId: Option[Int] = None, created: Option[Instant] = None) 
	extends StorableWithFactory[UserLanguage]
{
	// IMPLEMENTED	--------------------
	
	override def factory = UserLanguageModel.factory
