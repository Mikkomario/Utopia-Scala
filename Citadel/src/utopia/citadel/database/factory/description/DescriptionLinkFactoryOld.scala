...
@deprecated("Replaced with LinkedDescriptionFactory", "v2.0")
object DescriptionLinkFactoryOld
{
	// ATTRIBUTES	------------------------------
...
/**
  ...
  */
@deprecated("Replaced with LinkedDescriptionFactory", "v2.0")
trait DescriptionLinkFactoryOld[+E] extends LinkedFactory[E, Description] with Deprecatable
{
	// ABSTRACT	----------------------------------
