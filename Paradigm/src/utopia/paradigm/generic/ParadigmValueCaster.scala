...
import utopia.flow.generic.model.mutable.{DataType, DoubleType, DurationType, IntType, LocalTimeType, ModelType, PairType, StringType, VectorType}
...
object ParadigmValueCaster extends ValueCaster
{
    ...
    override lazy val conversions = Set[Conversion](
        // Conversions to Int
        immutable.Conversion(ColorType, IntType, CONTEXT_LOSS),
        // Conversions to Double
        immutable.Conversion(Vector2DType, DoubleType, DATA_LOSS),
        immutable.Conversion(Vector3DType, DoubleType, DATA_LOSS),
        immutable.Conversion(AngleType, DoubleType, CONTEXT_LOSS),
        immutable.Conversion(RotationType, DoubleType, CONTEXT_LOSS),
        immutable.Conversion(LinearVelocityType, DoubleType, CONTEXT_LOSS),
        immutable.Conversion(LinearAccelerationType, DoubleType, CONTEXT_LOSS),
        // Conversions to LocalTime
        immutable.Conversion(AngleType, LocalTimeType, MEANING_LOSS),
        // Conversions to Duration
        immutable.Conversion(RotationType, DurationType, MEANING_LOSS),
        // Conversions to Vector
        immutable.Conversion(Vector2DType, VectorType, CONTEXT_LOSS),
        immutable.Conversion(Vector3DType, VectorType, CONTEXT_LOSS),
        immutable.Conversion(PointType, VectorType, CONTEXT_LOSS),
        immutable.Conversion(SizeType, VectorType, CONTEXT_LOSS),
        immutable.Conversion(LineType, VectorType, CONTEXT_LOSS),
        immutable.Conversion(PolygonType, VectorType, CONTEXT_LOSS),
        immutable.Conversion(Matrix2DType, VectorType, CONTEXT_LOSS),
        immutable.Conversion(Matrix3DType, VectorType, CONTEXT_LOSS),
        immutable.Conversion(RgbType, VectorType, CONTEXT_LOSS),
        // Conversions to Pair
        immutable.Conversion(Vector2DType, PairType, CONTEXT_LOSS),
        immutable.Conversion(Vector3DType, PairType, DATA_LOSS),
        immutable.Conversion(PointType, PairType, CONTEXT_LOSS),
        immutable.Conversion(SizeType, PairType, CONTEXT_LOSS),
        immutable.Conversion(LineType, PairType, CONTEXT_LOSS),
        immutable.Conversion(BoundsType, PairType, CONTEXT_LOSS),
        immutable.Conversion(Matrix2DType, PairType, CONTEXT_LOSS),
        immutable.Conversion(LinearVelocityType, PairType, CONTEXT_LOSS),
        immutable.Conversion(Velocity2DType, PairType, CONTEXT_LOSS),
        immutable.Conversion(Velocity3DType, PairType, CONTEXT_LOSS),
        immutable.Conversion(LinearAccelerationType, PairType, CONTEXT_LOSS),
        immutable.Conversion(Acceleration2DType, PairType, CONTEXT_LOSS),
        immutable.Conversion(Acceleration3DType, PairType, CONTEXT_LOSS),
        // Conversions to Model
        immutable.Conversion(Vector2DType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(Vector3DType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(PointType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(SizeType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(LineType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(CircleType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(BoundsType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(LinearVelocityType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(Velocity2DType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(Velocity3DType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(LinearAccelerationType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(Acceleration2DType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(Acceleration3DType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(RgbType, ModelType, CONTEXT_LOSS),
        immutable.Conversion(HslType, ModelType, CONTEXT_LOSS),
        ...
        immutable.Conversion(Vector3DType, Vector2DType, DATA_LOSS),
        immutable.Conversion(PointType, Vector2DType, CONTEXT_LOSS),
        immutable.Conversion(SizeType, Vector2DType, CONTEXT_LOSS),
        immutable.Conversion(LineType, Vector2DType, DATA_LOSS),
        immutable.Conversion(Velocity2DType, Vector2DType, CONTEXT_LOSS),
        immutable.Conversion(Acceleration2DType, Vector2DType, CONTEXT_LOSS),
        ...
        immutable.Conversion(Velocity3DType, Vector3DType, CONTEXT_LOSS),
        immutable.Conversion(Acceleration3DType, Vector3DType, CONTEXT_LOSS),
        immutable.Conversion(ModelType, Vector3DType, DANGEROUS),
        immutable.Conversion(RgbType, Vector3DType, CONTEXT_LOSS),
        immutable.Conversion(HslType, Vector3DType, CONTEXT_LOSS),
        // Conversions to Point
        immutable.Conversion(Vector2DType, PointType, PERFECT),
        immutable.Conversion(SizeType, PointType, PERFECT),
        immutable.Conversion(BoundsType, PointType, DATA_LOSS),
        immutable.Conversion(ModelType, PointType, DANGEROUS),
        // Conversions to Size
        immutable.Conversion(Vector2DType, SizeType, PERFECT),
        immutable.Conversion(PointType, SizeType, CONTEXT_LOSS),
        immutable.Conversion(BoundsType, SizeType, DATA_LOSS),
        immutable.Conversion(ModelType, SizeType, DANGEROUS),
        // Conversions to Line
        immutable.Conversion(PairType, LineType, DANGEROUS),
        immutable.Conversion(BoundsType, LineType, MEANING_LOSS),
        immutable.Conversion(Matrix2DType, LineType, MEANING_LOSS),
        ...
        immutable.Conversion(LineType, PolygonType, MEANING_LOSS),
        immutable.Conversion(CircleType, PolygonType, DATA_LOSS),
        // Conversions to Bounds
        immutable.Conversion(PairType, BoundsType, DANGEROUS),
        immutable.Conversion(PolygonType, BoundsType, DATA_LOSS),
        immutable.Conversion(LineType, BoundsType, MEANING_LOSS),
        immutable.Conversion(CircleType, BoundsType, DATA_LOSS),
        ...
        immutable.Conversion(LineType, Matrix2DType, CONTEXT_LOSS),
        immutable.Conversion(BoundsType, Matrix2DType, MEANING_LOSS),
        immutable.Conversion(Matrix3DType, Matrix2DType, DATA_LOSS),
        immutable.Conversion(RotationType, Matrix2DType, CONTEXT_LOSS),
        immutable.Conversion(LinearTransformationType, Matrix2DType, DATA_LOSS),
        immutable.Conversion(VectorType, Matrix3DType, DANGEROUS),
        immutable.Conversion(Matrix2DType, Matrix3DType, PERFECT),
        immutable.Conversion(AffineTransformationType, Matrix3DType, DATA_LOSS),
        // Conversions to Angle
        immutable.Conversion(DoubleType, AngleType, PERFECT),
        immutable.Conversion(LocalTimeType, AngleType, DATA_LOSS),
        immutable.Conversion(Vector2DType, AngleType, DATA_LOSS),
        immutable.Conversion(Vector3DType, AngleType, MEANING_LOSS),
        immutable.Conversion(RotationType, AngleType, DATA_LOSS),
        immutable.Conversion(Velocity2DType, AngleType, DATA_LOSS),
        immutable.Conversion(Velocity3DType, AngleType, MEANING_LOSS),
        immutable.Conversion(Acceleration2DType, AngleType, DATA_LOSS),
        immutable.Conversion(Acceleration3DType, AngleType, MEANING_LOSS),
        immutable.Conversion(HslType, AngleType, DATA_LOSS),
        ...
        immutable.Conversion(DurationType, RotationType, CONTEXT_LOSS),
        immutable.Conversion(AngleType, RotationType, CONTEXT_LOSS),
        immutable.Conversion(LinearTransformationType, RotationType, DATA_LOSS),
        ...
        immutable.Conversion(LinearAccelerationType, LinearVelocityType, CONTEXT_LOSS),
        immutable.Conversion(Velocity2DType, LinearVelocityType, DATA_LOSS),
        immutable.Conversion(Velocity3DType, LinearVelocityType, DATA_LOSS),
        ...
        immutable.Conversion(Velocity3DType, Velocity2DType, DATA_LOSS),
        immutable.Conversion(Acceleration2DType, Velocity2DType, CONTEXT_LOSS),
        ...
        immutable.Conversion(Acceleration3DType, Velocity3DType, CONTEXT_LOSS),
        ...
        immutable.Conversion(LinearVelocityType, LinearAccelerationType, CONTEXT_LOSS),
        immutable.Conversion(Acceleration2DType, LinearAccelerationType, DATA_LOSS),
        immutable.Conversion(Acceleration3DType, LinearAccelerationType, DATA_LOSS),
        ...
        immutable.Conversion(Velocity2DType, Acceleration2DType, CONTEXT_LOSS),
        immutable.Conversion(Acceleration3DType, Acceleration2DType, DATA_LOSS),
        ...
        immutable.Conversion(Velocity3DType, Acceleration3DType, CONTEXT_LOSS),
        ...
        immutable.Conversion(AffineTransformationType, LinearTransformationType, DATA_LOSS),
        ...
        // Conversions to RGB
        immutable.Conversion(Vector3DType, RgbType, DATA_LOSS),
        ...
        // Conversions to HSL
        immutable.Conversion(Vector3DType, HslType, DATA_LOSS),
        immutable.Conversion(AngleType, HslType, CONTEXT_LOSS),
        ...
        immutable.Conversion(IntType, ColorType, MEANING_LOSS),
