...
import utopia.firmament.context.window.WindowContextWrapper2
...
/**
  ...
  */
trait ReachWindowContextWrapper2[Base <: ReachWindowContextCopyable[Base, _], +Repr, +Textual]
	extends WindowContextWrapper2[Base, Repr] with ReachWindowContextCopyable[Repr, Textual]
{
	// IMPLEMENTED  --------------------
