...
case class EmailValidationAttemptDataOld(purposeId: Int, email: String, token: String, resendToken: String,
                                         expires: Instant, userId: Option[Int] = None, created: Instant = Now,
