...
case class DbSingleEmailValidationAttemptOld(id: Int)
	extends UniqueEmailValidationAttemptAccessOld with SingleIntIdModelAccess[EmailValidationAttemptOld]
{
