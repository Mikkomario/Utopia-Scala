...
object EmailValidationAttemptModelOld
	extends DataInserter[EmailValidationAttemptModelOld, EmailValidationAttemptOld, EmailValidationAttemptDataOld]
		with Expiring
{
	// ATTRIBUTES	--------------------
	...
	/**
	  ...
	  */
	def factory = EmailValidationAttemptFactoryOld
	...
	override def apply(data: EmailValidationAttemptDataOld) =
	...
	override def complete(id: Value, data: EmailValidationAttemptDataOld) = EmailValidationAttemptOld(id.getInt,
		data)
...
/**
  ...
  */
@deprecated("Replaced with a new version", "v4.0")
case class EmailValidationAttemptModelOld(id: Option[Int] = None, purposeId: Option[Int] = None,
                                          email: Option[String] = None, token: Option[String] = None,
                                          resendToken: Option[String] = None, expires: Option[Instant] = None,
                                          userId: Option[Int] = None, created: Option[Instant] = None,
                                          completed: Option[Instant] = None)
	extends StorableWithFactory[EmailValidationAttemptOld]
{
	// IMPLEMENTED	--------------------
	
	override def factory = EmailValidationAttemptModelOld.factory
	
	override def valueProperties =
	{
		import EmailValidationAttemptModelOld._
