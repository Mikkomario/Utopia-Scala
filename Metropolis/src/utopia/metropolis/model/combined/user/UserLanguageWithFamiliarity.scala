...
/**
  ...
  * @since 2021-10-23
  */
case class UserLanguageWithFamiliarity(languageLink: UserLanguage, familiarity: LanguageFamiliarity) 
	extends Extender[UserLanguageData] with StyledModelConvertible
{
	// COMPUTED	--------------------
