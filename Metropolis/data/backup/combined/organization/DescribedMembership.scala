...
object DescribedMembership extends FromModelFactory[DetailedMembership]
{
...
/**
  ...
  * @since 1.12.2020, v1
  */
case class DescribedMembership(wrapped: Membership, roles: Set[UserRoleWithRights], userData: UserSettings)
