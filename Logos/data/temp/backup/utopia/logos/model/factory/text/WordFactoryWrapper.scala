...
/**
  * Common trait for classes that implement WordFactory by wrapping a WordFactory instance
  * @tparam A Type of constructed instances
  * @tparam Repr Implementing type of this factory
  * @author Mikko Hilpinen
  * @since 27.08.2024, v0.3
  */
trait WordFactoryWrapper[A <: WordFactory[A], +Repr] extends WordFactory[Repr]
{
	// ABSTRACT	--------------------
